...
def readHexosForReferenceDischargesAveraged(dischargeID: list[str] =['20241008.40', '20241009.9', '20241016.14', '20241114.10', '20241127.10', '20241205.9', '20241210.7', '20241212.9', 
    ...
    for counter, shotnumber in enumerate(dischargeID):
        ...
        if i == 1 and changed:
            ax2.axvline(counter - 0.5, color='grey', label='Grenze zwischen OP2.2 und OP2.3')
    ax[0][0].set_xlabel('Zeit t in (s)')
    ax[0][1].set_xlabel('Zeit t in (s)')
    ax[1][0].set_xlabel('Zeit t in (s)')
    ax[1][1].set_xlabel('Zeit t in (s)')
    ax[0][0].set_ylabel('Gemittelte Intensität der C-II Spektrallinie (133.510nm)')
    #ax[0][1].set_ylabel('Gemittelte Intensität der C-II Spektrallinie (133.510nm)')
    ax[1][0].set_ylabel('Gemittelte Intensität der O-III Spektrallinie (83.430nm)')
    #ax[1][1].set_ylabel('Gemittelte Intensität der O-III Spektrallinie (83.430nm) OP2.3')
    ax[0][0].legend(loc='center left', bbox_to_anchor=(1, 0.5))
    ax[0][1].legend(loc='center left', bbox_to_anchor=(1, 0.5))
    ax[1][0].legend(loc='center left', bbox_to_anchor=(1, 0.5))
    ax[1][1].legend(loc='center left', bbox_to_anchor=(1, 0.5))
    ...
    ax2.set_xlabel('Nummer der Referenzentladung')
    ax2.set_ylabel('Gemittelte Intensität der Spektrallinie')
    ax2.legend()
